...
/* package heist-0.5.2.1 */
#define VERSION_heist "0.5.2.1"
...
/* package snap-0.5.2 */
#define VERSION_snap "0.5.2"
#define MIN_VERSION_snap(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 2)

/* package snap-core-0.5.2 */
#define VERSION_snap_core "0.5.2"
#define MIN_VERSION_snap_core(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 2)

/* package snap-server-0.5.2 */
#define VERSION_snap_server "0.5.2"
...
/* package xmlhtml-0.1.5.2 */
#define VERSION_xmlhtml "0.1.5.2"
